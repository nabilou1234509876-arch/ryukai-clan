...
export default function AboutSection() {
  return (
    <section className="py-24 relative overflow-hidden">
      {/* Background accents */}
      <div className="absolute top-1/2 right-0 w-[500px] h-[500px] bg-ryukai-blue/10 rounded-full blur-[100px] pointer-events-none -translate-y-1/2 translate-x-1/3" />
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            <div>
              <h2 className="font-heading font-bold text-4xl md:text-5xl text-white uppercase tracking-wider mb-2">
                Who is <span className="text-ryukai-blue">Ryukai?</span>
              </h2>
              <div className="w-20 h-1 bg-ryukai-blue box-glow" />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
              <div className="glass-panel p-6 border-l-2 border-l-ryukai-blue">
          ...
          >
            <div className="relative aspect-[4/3] w-full max-w-lg mx-auto rounded-lg overflow-hidden glass-panel p-2">
              <div className="absolute inset-0 bg-ryukai-blue/20 mix-blend-overlay z-10" />
              <div className="w-full h-full bg-ryukai-dark rounded flex items-center justify-center border border-ryukai-border relative overflow-hidden">
                ...
                <div className="z-20 text-center">
                  <div className="w-24 h-24 mx-auto rounded-full border-2 border-ryukai-blue flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(0,68,255,0.3)]">
                ...
                <motion.div 
                  ...
                  className="absolute left-0 w-full h-1 bg-ryukai-blue/50 shadow-[0_0_20px_rgba(0,68,255,0.8)] z-30"
                />
              </div>
            </div>
            
            {/* Decorative elements behind image */}
            <div className="absolute top-10 -right-10 w-32 h-32 border border-ryukai-blue/20 rounded-full -z-10 animate-[spin_10s_linear_infinite]" />
            <div className="absolute -bottom-5 -left-5 w-48 h-48 border border-white/5 rounded-full -z-10" />
          </motion.div>
