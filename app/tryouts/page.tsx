      ...
      <div className="container mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto mb-24">
          ...
          <div className="glass-panel p-8 relative overflow-hidden group">
            <div className="absolute top-0 left-0 w-full h-1 bg-ryukai-border group-hover:bg-ryukai-blue transition-colors duration-300" />
            <div className="text-6xl font-heading font-bold text-white/5 absolute -top-4 -right-2">01</div>
            
            <div className="w-14 h-14 bg-ryukai-dark border border-ryukai-border rounded-lg flex items-center justify-center mb-6 text-ryukai-blue group-hover:scale-110 transition-transform duration-300">
        ...
        {/* Requirements & Action */}
        <div className="max-w-4xl mx-auto glass-panel border border-ryukai-blue/30 p-8 md:p-12 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-ryukai-blue/10 rounded-full blur-[80px]" />
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
            <div className="flex-1">
              ...
              <ul className="space-y-3 font-body text-gray-300">
                <li className="flex items-center gap-3">
                  <div className="w-1.5 h-1.5 rounded-full bg-ryukai-blue" />
            ...
            <div className="w-full md:w-auto">
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                className="group flex items-center justify-center gap-3 w-full md:w-auto px-10 py-5 bg-ryukai-blue text-white font-heading font-bold text-xl uppercase tracking-wider rounded box-glow hover:bg-ryukai-blue/90 transition-all"
              >
